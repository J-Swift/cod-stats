  ...
  SELECT * FROM (
    WITH cte_seasons(id, desc, start, end, sort_order) AS (
      VALUES
        ...
        ('season01', 'Season 1',   '1970-01-01T00:00:01Z', '2020-02-11T17:59:59Z', 18),
        ('season02', 'Season 2',   '2020-02-11T18:00:00Z', '2020-04-07T23:59:59Z', 17),
        ('season03', 'Season 3',   '2020-04-08T00:00:00Z', '2020-06-11T02:59:59Z', 16),
        ('season04', 'Season 4',   '2020-06-11T03:00:00Z', '2020-08-04T23:59:59Z', 15),
        ('season05', 'Season 5',   '2020-08-05T00:00:00Z', '2020-09-28T23:59:59Z', 14),
        ('season06', 'Season 6',   '2020-09-29T00:00:00Z', '2020-12-16T23:59:59Z', 13),
        ('season11', 'Season BO1', '2020-12-17T00:00:00Z', '2021-02-25T23:59:59Z', 12),
        ('season12', 'Season BO2', '2021-02-26T00:00:00Z', '2021-04-21T23:59:59Z', 11),
        ('season13', 'Season BO3', '2021-04-22T00:00:00Z', '2021-06-16T23:59:59Z', 10),
        ('season14', 'Season BO4', '2021-06-17T00:00:00Z', '2021-08-12T23:59:59Z', 9),
        ('season15', 'Season BO5', '2021-08-13T00:00:00Z', '2021-10-06T23:59:59Z', 8),
        ('season16', 'Season BO6', '2021-10-07T00:00:00Z', '2021-12-07T23:59:59Z', 7),
        ('season21', 'Season VG1', '2021-12-08T00:00:00Z', '2022-03-22T15:59:59Z', 6),
        ('season22', 'Season VG2', '2022-03-22T16:00:00Z', '2022-04-27T15:59:59Z', 5),
        ('season23', 'Season VG3', '2022-04-27T16:00:00Z', '2022-06-22T11:59:59Z', 4),
        ('season24', 'Season VG4', '2022-06-22T12:00:00Z', '2022-08-24T15:59:59Z', 3),
        ('season25', 'Season VG5', '2022-08-24T16:00:00Z', '2027-08-11T23:59:59Z', 2)
    )
...
CREATE VIEW vw_unknown_modes_wz AS
  SELECT
    json_extract(stats, '$.mode') mode,
    strftime('%Y-%m-%dT%H:%M:%SZ', min(json_extract(stats, '$.utcEndSeconds')), 'unixepoch') firstSeen,
    strftime('%Y-%m-%dT%H:%M:%SZ', max(json_extract(stats, '$.utcEndSeconds')), 'unixepoch') lastSeen,
    count(1) totalGames
  FROM raw_games
