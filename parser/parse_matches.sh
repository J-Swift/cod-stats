  ...
  SELECT * FROM (
    WITH cte_seasons(id, desc, start, end, sort_order) AS (
      VALUES
        ...
        ('season01', 'Season 1', '1970-01-01T00:00:01Z', '2020-02-11T17:59:59Z', 7),
        ('season02', 'Season 2', '2020-02-11T18:00:00Z', '2020-04-07T23:59:59Z', 6),
        ('season03', 'Season 3', '2020-04-08T00:00:00Z', '2020-06-11T02:59:59Z', 5),
        ('season04', 'Season 4', '2020-06-11T03:00:00Z', '2020-08-04T23:59:59Z', 4),
        ('season05', 'Season 5', '2020-08-05T00:00:00Z', '2020-09-28T23:59:59Z', 3),
        ('season05', 'Season 6', '2020-09-29T00:00:00Z', '2286-11-20T17:46:38Z', 2)
    )
